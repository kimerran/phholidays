...
Public Class HolidayData
    ...
    Private Sub Load_Holidays()
        ...
        'October
        Holidays.Add(New Holiday(#10/15/2013#,
                                 "Eidul Adha",
                                 "Celebration of the Eidul Adha, considered as one of the two greatest feasts of Islam. The date of the festival is based on the declaration made by Saudi Arabia’s highest religious body.",
                                 HolidayType.RegularHoliday,
                                 "eidl"))
